...
dsy.add("0_22_0",["青羊区","锦江区","金牛区","武侯区","成华区","高新区","龙泉驿区","青白江区","新都区","温江区","都江堰市","彭州市","邛崃市","崇州市","金堂县","赵镇","双流县","郫县","郫筒镇","大邑县","晋原镇","蒲江县","鹤山镇","新津县","五津镇"]);
...
var opt0 = ["请选择省份","请选择市","请选择区|县"];//初始值
function _init_area(x,y,z){  //初始化函数
	if(z){
		//opt0 = [x,y,z]; //2016-06-03 去掉默认显示己选择的
	}
