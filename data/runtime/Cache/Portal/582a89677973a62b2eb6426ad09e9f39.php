...
<body>
	...
	<div id="record">
		<ul>
			<li><span><img src="/shares/tpl/simplebootx_mobile/Public/image/people.png" alt=""></span><span class="back_hired_money">&nbsp;&nbsp;&nbsp;&nbsp;总人数：<span>60 人</span></span></li><li><span>手机号码：</span><span class="back_hired_money"><input type="text" name="" placeholder="请输入手机号码"></li>
		</ul>
	</div>
	<div id="query">
