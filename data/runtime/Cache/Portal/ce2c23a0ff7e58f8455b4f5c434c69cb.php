...
<head>
	...
	<link rel="stylesheet" href="/shares/tpl/simplebootx_mobile/Public/style/recharge.css" type="text/css">
	<style>
...
<body>
	...
	<div id="container">
		...
		<div class="charge_way" style="padding: 0; margin-bottom: 0">
			<div>
				<p>提现方式</p>
				<p class="pay"><img src="/shares/tpl/simplebootx_mobile/Public/image/weixin.gif">微信提现<span class="pay_btn"></span></p>
			</div>
