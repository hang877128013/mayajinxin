					...
					<div class="tab-content">
						<div class="tab-pane active" id="A">
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label">公司网站名称：</label>
									<div class="controls">
										<input type="text" class="input" name="options[site_pcname]" value="<?php echo ($site_pcname); ?>"><span class="must_red">*</span>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									<label class="control-label">会员提现手续费：</label>
									<div class="controls">
										<input type="text" class="input" name="options[site_txhy]" style="width: 30px;text-align: right" value="<?php echo ($site_txhy); ?>"><span class="must_red">元/笔</span>
									</div>
								</div>
								
								<div class="control-group">
									<label class="control-label">银行卡信息（多个换行填写）：</label>
									<div class="controls">
										<textarea name="options[site_yhcard]" rows="5" cols="57"><?php echo ($site_yhcard); ?></textarea>
									</div>
								</div>
								<!-- <div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea name="options[site_AppSecret]" rows="5" cols="57"><?php echo ($site_AppSecret); ?></textarea>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">AppId：</label>
									<div class="controls">
										<textarea name="options[site_AppId]" rows="5" cols="57"><?php echo ($site_AppId); ?></textarea>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">短信接口用户ID：</label>
									<div class="controls">
										<input type="text" class="input" name="options[site_smsuserid]" value="<?php echo ($site_smsuserid); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">短信接口账号：</label>
									<div class="controls">
										<input type="text" class="input" name="options[site_smsuser]" value="<?php echo ($site_smsuser); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">短信接口密码：</label>
									<div class="controls">
										<input type="text" class="input" name="options[site_smspass]" value="<?php echo ($site_smspass); ?>">
									</div>
								</div>
							</fieldset>
						</div>
