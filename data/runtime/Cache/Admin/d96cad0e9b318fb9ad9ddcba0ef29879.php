...
<div class="wrap J_check_wrap">
	<ul class="nav nav-tabs">
		<li class="active"><a href="<?php echo U('Withdrawdcl/index');?>">待处理提现</a></li>
	</ul>
	<form action="<?php echo U('Withdrawdcl/index');?>" method="post" name="search" class="well form-search" id="search">
	...
	<span><form action="<?php echo U('Withdrawdcl/dctx');?>" method="post" name="export" target="_blank" id="export">
	...
	<form class="J_ajaxForm" action="" method="post">
		<table class="table table-hover table-bordered table-list" id="menus-table">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
						<a href="<?php echo U('Withdrawdcl/enable',array('id'=>$vo['id'],'t'=>2));?>" class="J_ajax_dialog_btn" data-msg="你确定进行此操作吗？">已处理</a> |
						<!--<a href="<?php echo U('Withdrawdcl/enable',array('id'=>$vo['id'],'t'=>1));?>" class="J_ajax_dialog_btn" data-msg="你确定进行此操作吗？">待处理</a>-->					</td>
		...
		<div class="table-actions">
			<button class="btn btn-primary btn-small J_ajax_submit_btn" type="submit" data-action="<?php echo U('Withdrawdcl/enable',array('t'=>2));?>" data-subcheck="true" data-msg="你确定进行此操作吗？">已处理</button>
			<!--<button class="btn btn-primary btn-small J_ajax_submit_btn" type="submit" data-action="<?php echo U('Withdrawdcl/enable',array('t'=>1));?>" data-subcheck="true" data-msg="你确定进行此操作吗？">待处理</button>-->
		</div>
