...
<div class="wrap J_check_wrap">
    ...
    <form class="well form-search" method="post" action="<?php echo U('Settlement/calculate');?>">
        <div class="search_type cc mb10">
            <div class="mb10">
					<span class="mr20">
						<input type="text" name="keyword" style="width: 200px;" value="<?php echo ($formget["keyword"]); ?>" placeholder="请输入所属..."> &nbsp; &nbsp;
						<input type="text" name="keyword" style="width: 200px;" value="<?php echo ($formget["keyword"]); ?>" placeholder="请输入手机号码..."> &nbsp; &nbsp;
						<input type="text" name="keyword" style="width: 200px;" value="<?php echo ($formget["keyword"]); ?>" placeholder="经纪人名称..."> &nbsp; &nbsp;
