...
{name:'澳门', areaList:['澳门']}
    ...
    if (!input1) {
        $(".input1").val("四川");
            ...
            var data2 = {};
            chazhao(input1);
            var html2 = template('showlist2',data2);
            $(".city").append(html2);
            //alert($(".input2").val());
            if (!$(".input2").val()) {
                $(".input2").val(data2.content['0'].name);
            }
                    //默认区域
                    var input2 = $(".input2").val();
                    var data3 = {};
                    chazhao2(input2, data2);
                    var html3 = template('showlist3',data3);
                    $(".area").append(html3);
                    if (!$(".input3").val()) {
                        $(".input3").val(data3.content['0']);
                    }
                    //点击区域
    ...
    //显示
    $(".select_city .icon-caret-down").click(function(){
    ...
    function quyu(){
        ...
        chazhao2(input2, data2);
        $(".quyu").remove();
        html3 = template('showlist3',data3);
        $(".area").append(html3);
        $(".input3").val(data3.content['0']);
        //点击区域
        $(".area ul li").on('click', function(){
    ...
    function chazhao2(input2, datas){
        $.each(datas.content, function(k,v){
